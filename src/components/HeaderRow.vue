<template>
    <div class="container" id="headerrow">
            <div class="row">
                ...
                <div class="col-lg-6 fixed-header">
                    <div class="row ">
                        ...
                        <div v-for="party in $store.state.parties"
                            ...
                            <img :src="GLP" v-else-if="party.name == 'GLP'" class="svg-party-logo"/>
                            <img :src="GP" v-else-if="party.name == 'GP'" class="svg-party-logo"/>
                            <img :src="SP" v-else-if="party.name == 'SP'" class="svg-party-logo"/>
                        </div>
                    </div>
            </div>
        </div>
...
<style>
 .sticky {
     ...
     background: linear-gradient(180deg, rgba(255,255,255,1) 0%, rgba(255,255,255,1) 67%, rgba(255,255,255,0.4254742547425474) 100%);
 }
